...
namespace e_crime.Migrations
{
    ...
    [Migration("20240520115653_defineCrime_User_Relationship")]
    partial class defineCrime_User_Relationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("e_crime.Models.UserCrime", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasKey("UserId", "CrimeId");

                    b.HasIndex("CrimeId");

                    b.ToTable("UserCrimes");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("e_crime.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("e_crime.Models.UserCrime", b =>
                {
                    b.HasOne("e_crime.Models.Crime", "Crime")
                        .WithMany("UserCrimes")
                        .HasForeignKey("CrimeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("e_crime.Data.ApplicationUser", "ApplicationUser")
                        .WithMany("UserCrimes")
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
