...
const paths = {
  ...
  dist:   {
    ...
    libs:   {
      dir:    './wwwroot/dist/assets/libs'
    },
    css:    {
      dir:    './wwwroot/dist/assets/css',
    },
    js:    {
      dir:    './wwwroot/dist/assets/js',
      files:  './wwwroot/dist/assets/js/pages',
    },
  },
  src:    {
    base:   {
    ...
    css:    {
      dir:    './wwwroot/src/assets/css',
      files:  './wwwroot/src/assets/css/**/*'
    },
    html:   {
      dir:    './wwwroot/src',
      files:  './wwwroot/src/**/*.html',
    },
    img:    {
      dir:    './wwwroot/src/assets/images',
        files:  './wwwroot/src/assets/images/**/*',
    },
    js:     {
        dir:    './wwwroot/src/assets/js',
        pages:  './wwwroot/src/assets/js/pages',
        files:  './wwwroot/src/assets/js/pages/*.js',
        main:   './wwwroot/src/assets/js/*.js',
    },
    partials:   {
        dir:    './wwwroot/src/partials',
        files:  './wwwroot/src/partials/**/*'
    },
    scss:   {
        dir:    './wwwroot/src/assets/scss',
        files:  './wwwroot/src/assets/scss/**/*',
        main:   './wwwroot/src/assets/scss/*.scss'
    }
  }
};
